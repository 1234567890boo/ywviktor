...
class Fruit:
    def __init__(self):
        ...
        self.apple=Radiobutton(self.window,text='apple',variable=self.select,value='apple')
        self.banana=Radiobutton(self.window,text='banana',variable=self.select,value='banana')
        self.orange=Radiobutton(self.window,text='orange',variable=self.select,value='orange')
        self.mango=Radiobutton(self.window,text='mango',variable=self.select,value='mango')
        self.grape=Radiobutton(self.window,text='grape',variable=self.select,value='grape')
        self.peach=Radiobutton(self.window,text='peach',variable=self.select,value='peach')
