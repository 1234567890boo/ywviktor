...
class Fruit:
    def __init__(self,fruits):
        ...
        for n in self.fruits.keys():
            self.butt[n]=Radiobutton(self.window,text=n,variable=self.select,value=n)
    ...
    def findprice(self):
        ...
        self.l2['text']='you have to pay $'+str(self.fruits[fruit]['price']*num)+' for '+str(self.select.get())
